...
function validarData($data) {
	$DT = date('Y-m-d');
	$dtConculta = new DateTime($data);
	$dtFinal = new DateTime($DT);
	return $dtFinal < $dtConculta;
}
...
//} else {
	//$_SESSION['msg'] = "<div class='alert alert-danger' role='alert'>Data invalida <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button></div>";
	//header("Location: index.php");
//}
