			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						<li class="hidden">
							<a href="<?php echo base_url(); ?>public/#page-top"></a>
						</li>
						<li>
			...
			<div class="container">
				<div class="slider-container">
					<div class="intro-text">
						...
						<div class="intro-heading">Seconsult</div>
						<a href="#about" class="page-scroll btn btn-xl">Quem somos</a>
					</div>
				</div>
			</div>
		</header>
				...
				<div class="row">
					<div class="col-lg-12 text-center">
						<div class="section-title">
							<h2>Sobre</h2>
							<p>Colocar um texto de descrição aqui</p>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-3 text-center">
						<div class="mz-module-about">
							...
							<img src="public/images/agenda.png" alt="">
							<br><br>
							<h3>Visualização de agenda</h3>
					...
					<div class="col-md-3 text-center">
						<div class="mz-module-about">
							...
							<img src="public/images/Prontuario.png" alt="">
							<br><br>
							<h3>Prontuario</h3>
					...
					<div class="col-md-3 text-center">
						<div class="mz-module-about">
							...
							<img src="public/images/pie-chart.png" alt="">
							<br><br>
							<h3>Graficos</h3>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="team-item">
							...
							<div class="team-text">
								<h3>Leilson Oliveira</h3>
								<div class="team-location">Barbalha, Brasil</div>
								<div class="team-position">– Gerente de projeto –</div>
								<p>Texto para adicionar aqui a respeito do gerente de projeto texto texto texto tetxto texto</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="team-item">
							...
							<div class="team-text">
								<h3>Wesley Junior</h3>
								<div class="team-location">Juazeiro do norte, Brasil</div>
								<div class="team-position">– Analista –</div>
								<p>Texto para adicionar aqui a respeito do analist de projeto texto texto texto tetxto texto</p>
							</div>
						</div>
					</div>
					<!-- end team member item -->
					...
					<div class="col-md-3">
						<div class="team-item">
							...
							<div class="team-text">
								...
								<p>Texto para adicionar aqui a respeito do desenvolvedor de projeto texto texto texto tetxto texto</p>
							</div>
						</div>
					</div>
					<!-- end team member item -->
					...
					<div class="col-md-3">
						<div class="team-item">
							...
							<div class="team-text">
								<h3>Renato da Silva Marques</h3>
								<div class="team-location">cidade, Pais</div>
								<div class="team-position">– Orientador –</div>
