...
<html lang="pt-br">
	<head>
		<meta charset='utf-8' />
		<title>Agenda</title>
		<link href='<?php echo base_url(); ?>Full/css/bootstrap.min.css' rel='stylesheet'>
		<link href='<?php echo base_url(); ?>Full/css/fullcalendar.min.css' rel='stylesheet' />
		<link href='<?php echo base_url(); ?>Full/css/fullcalendar.print.min.css' rel='stylesheet' media='print' />
		<link href='<?php echo base_url(); ?>Full/css/personalizado.css' rel='stylesheet' />
		<script src='<?php echo base_url(); ?>Full/js/jquery.min.js'></script>
		<script src='<?php echo base_url(); ?>Full/js/bootstrap.min.js'></script>
		<script src='<?php echo base_url(); ?>Full/js/moment.min.js'></script>
		<script src='<?php echo base_url(); ?>Full/js/fullcalendar.min.js'></script>
		<script src='<?php echo base_url(); ?>Full/js/jquery.mask.js'></script>
		<script src='<?php echo base_url(); ?>Full/locale/pt-br.js'></script>
		<script>
